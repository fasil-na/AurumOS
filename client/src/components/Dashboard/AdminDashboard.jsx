...
const AdminDashboard = () => {
  ...
  const handleInvite = async (e) => {
    ...
    setLoading(true);
    try {
      await api.post('/invites', { email, role: 'Employee' });
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <h2 className="mb-6 text-2xl font-bold text-gray-800">Admin Dashboard</h2>
        
        <div className="mb-8 rounded-lg bg-white p-6 shadow">
          <h3 className="mb-4 text-lg font-medium">Invite New Employee</h3>
        ...
        <div className="rounded-lg bg-white shadow">
          <div className="border-b px-6 py-4">
            <h3 className="text-lg font-medium">Employee Invitations</h3>
          </div>
            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="divide-y divide-gray-200 bg-white">
                ...
                {invitations.length === 0 && (
                  <tr>
                    <td colSpan="4" className="px-6 py-4 text-center text-sm text-gray-500">No invitations found</td>
                  </tr>
                )}
              </tbody>
            </table>
